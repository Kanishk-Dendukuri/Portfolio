...
The next game I worked on is called [Spelunk Knight](https://github.com/EPHS-iOS/knight). Spelunk Knight a metroidvania where the player has to explore the map to find abilities to be able to reach other parts of the map. While developing the game I learned how to create animated art. This was a big step for me because I didnt have any expirence with art before. Another thing I learned while learning is game design and how to make a large map while still making it entertaining. We were also able to get this app into the [app store](https://apps.apple.com/tt/app/spelunk-knight/id1612481607) and is avaiable for iPhone, iPad.
